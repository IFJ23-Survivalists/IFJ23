 ...
 * @date 25/09/2023
 * @brief Simple testsuit that I got from https://github.com/marcizhu/ChaCha20/blob/master/tests.c
 */
...
static void summary(void){if(tst>0&&prev==err)printf("\r \x1b[32m✓\x1b[0m \n");printf("\r  \n\x1b[1m\x1b[33m    %d total", tst);printf("\x1b[1m\x1b[32m   %d passed",tst-err);printf("\x1b[1m\x1b[31m   %d failed\x1b[0m\n",err);exit(err);}
