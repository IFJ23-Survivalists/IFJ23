...
int main(int argc, char* argv[]) {
    ...
    g.add_rule(NTerm_Statement, "tnanan", Token_If, NTerm_IfCondition, '{', NTerm_StatementList, '}', NTerm_Else);
    ...
    g.add_rule(NTerm_Else, "tanan", Token_Else, '{', NTerm_StatementList, '}', NTerm_StatementList);
